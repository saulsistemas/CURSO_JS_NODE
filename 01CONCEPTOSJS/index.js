...
console.log("==================== 13 REPASO CALLBACKS ==================== ");
//callback-Funcion que se manda por argumento a otra funcion
const getUsuarioById = function(id,callback) {
    const usuario ={
        id,
        nombre:"Carlos",
    }
...
console.log("-------------ejemplo de callbacks------------- ");
const empleadosBD = [
    {
        id:1,
        nombre:"Juan"
...
//ASYNC TRANSFORMA UNA FUNCION AINCRONA PARA REGRESAR UNA PROMESA
//AWAIT 
